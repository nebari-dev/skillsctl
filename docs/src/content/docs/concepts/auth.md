...
- [Versioning and ownership](/concepts/versioning/) - how OIDC subjects relate to skill ownership
- [Configuration reference](/server/configuration/) - OIDC environment variables
