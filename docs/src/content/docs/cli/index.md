...
| Command | Description |
|---------|-------------|
| [explore](/cli/explore/) | Browse skills in the registry |
| [install](/cli/install/) | Install a skill to your local skills directory |
| [publish](/cli/publish/) | Publish a skill to the registry |
| [auth](/cli/auth/) | Log in, check status, or log out |
...
See the [config command reference](/cli/config/) for details.
