...
- SkillsCtl CLI [installed](/getting-started/installation/)
...
Dev mode is useful for local development and evaluation. For production deployments, configure OIDC. See the [server documentation](/server/) for details.

## Next steps

- [Explore skills](/getting-started/exploring/) - browse a registry with existing skills
- [Publish a skill](/getting-started/publishing/) - add your first skill to the local registry
- [Configuration](/getting-started/configuration/) - set options like a production server URL
