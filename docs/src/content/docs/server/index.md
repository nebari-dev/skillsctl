...
| Guide | When to use |
|-------|-------------|
| [Local and Docker](/server/local/) | Development, evaluation, single-machine deployments |
| [Kubernetes (Helm)](/server/kubernetes/) | Production Kubernetes clusters |
| [Nebari integration](/server/nebari/) | Clusters running the nebari-operator |
