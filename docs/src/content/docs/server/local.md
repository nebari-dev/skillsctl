...
See [Configuration reference](/server/configuration/) for all available variables.
...
- [Kubernetes deployment](/server/kubernetes/) - Helm chart for production clusters
- [Configuration reference](/server/configuration/) - all environment variables
